...
namespace gpu {
static __device__ Active<real>::forward  forward [] = { sigmoid, relu, tanh, linear };  // NOLINT
static __device__ Active<real>::backward backward[] = { sigmoid, relu, tanh, linear };  // NOLINT
}
